...
const redirect = encodeURIComponent('https://login-discord-passport.herokuapp.com/api/auth/login/redirect');
...
router.get('/callback', async (req,res,next)=>{
	...
	const data = {
		...
		code,
		redirect_uri:'https://login-discord-passport.herokuapp.com/api/auth/login/redirect',
